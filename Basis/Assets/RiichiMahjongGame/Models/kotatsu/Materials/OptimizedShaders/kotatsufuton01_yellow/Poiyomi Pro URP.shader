Shader "Hidden/Locked/.poiyomi/Poiyomi Pro URP/121821c36b8222242b0161242072d1f4"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			inout PoiShadingParams params)
			{
				...
				poiLight.directColor = 1.0 ? MaxLuminance(additiveColorNoShadows, 1.17) : additiveColorNoShadows;
				poiLight.indirectColor = lerp(0, additiveColorNoShadows, 0.0);
				poiLight.indirectColor = 1.0 ? MaxLuminance(poiLight.indirectColor, 1.17) : poiLight.indirectColor;
			...
			inout PoiShadingParams params)
			{
				...
				if (1.0 >= 0.5)
				{
					...
					for (int index = 0; index < 4; index++)
					{
						...
						poiLight.vColor[index] = 1.0 ? MaxLuminance(col, 1.17) : col;

Shader "Hidden/Locked/.poiyomi/Poiyomi Pro URP/cce71ede38179a44f8b2880ebdc94188"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyMainColor(inout PoiFragData poiFragData, inout PoiMesh poiMesh, inout PoiCam poiCam, inout PoiMods poiMods, inout float4 mainTexture)
			{
				...
				poiFragData.baseColor *= poiThemeColor(poiMods, float4(0.8214345,0.4303029,0.07120392,1).rgb, 0.0);
				poiFragData.alpha = mainTexture.a * float4(0.8214345,0.4303029,0.07120392,1).a;
				#else

Shader "Hidden/Locked/.poiyomi/Poiyomi Pro URP/3eccd72c1b2854543a7bd64483c0653e"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyMainColor(inout PoiFragData poiFragData, inout PoiMesh poiMesh, inout PoiCam poiCam, inout PoiMods poiMods, inout float4 mainTexture)
			{
				...
				poiFragData.baseColor *= poiThemeColor(poiMods, float4(1,0,0.9353951,1).rgb, 0.0);
				poiFragData.alpha = mainTexture.a * float4(1,0,0.9353951,1).a;
				#else

Shader "Hidden/Locked/.poiyomi/Poiyomi Pro URP/d5b103a482514564b9b1da3cebb72ebf"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyMainColor(inout PoiFragData poiFragData, inout PoiMesh poiMesh, inout PoiCam poiCam, inout PoiMods poiMods, inout float4 mainTexture)
			{
				...
				poiFragData.baseColor *= poiThemeColor(poiMods, float4(0.8214345,0,0.4885376,1).rgb, 0.0);
				poiFragData.alpha = mainTexture.a * float4(0.8214345,0,0.4885376,1).a;
				#else
			...
			float4 frag(VertexOut i, bool facing : SV_IsFrontFace) : SV_Target
			{
				...
				if (1.0 == POI_MODE_CUTOUT && 0.0 < 0.5)
				{
					poiFragData.alpha = 1;
				}
